# Goobi workflow Plugin: goobi-plugin-import-crown
...
- Select as template `goobi-workflow/goobi-plugin-import-sample`
- Select as `Owner` the value `goobi-workflow`
- Define a `Repository name` based on convention, e.g.  `goobi-plugin-import-myPlugin`
...
- Open Eclipse and checkout the new created Repository. You will find a new project with the name `A-goobi-plugin-import-sample` there.
- Right-click on the new project and refactor/rename it to your plugin name, e.g. `goobi-plugin-import-myPlugin`
...
- The plugin is now created and ready to be used. Remember to commit your changes and don't forget to update the README.md file that is located on folder upwards of the eclipse project. As it does not get committed by Eclipse you can commit it with these commands:
  ...
  ```
  cd ~/git/goobi-plugin-import-myPlugin
...
Detail | Description
--- | ---
**Plugin identifier**       | intranda_import_sample
